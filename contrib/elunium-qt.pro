...
RESOURCES += src/qt/elunium.qrc src/qt/elunium_locale.qrc

TRANSLATIONS += src/qt/locale/elunium_bg.ts \
                src/qt/locale/elunium_de.ts \
                src/qt/locale/elunium_en.ts \
                src/qt/locale/elunium_es.ts \
                src/qt/locale/elunium_fi.ts \
                src/qt/locale/elunium_fr.ts \
                src/qt/locale/elunium_it.ts \
                src/qt/locale/elunium_ja.ts \
                src/qt/locale/elunium_pl.ts \
                src/qt/locale/elunium_pt.ts \
                src/qt/locale/elunium_ru.ts \
                src/qt/locale/elunium_sk.ts \
                src/qt/locale/elunium_sv.ts \
                src/qt/locale/elunium_vi.ts \
                src/qt/locale/elunium_zh_CN.ts \
                src/qt/locale/elunium_zh_TW.ts
