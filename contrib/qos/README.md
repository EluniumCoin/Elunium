...
This means one can have an always-on eluniumd instance running, and another local eluniumd/elunium-qt instance which connects to this node and receives blocks from it.
