...
/** Utility functions used by the Elunium Qt UI.
 */
namespace GUIUtil
{
...
// Render ELUNIUM addresses in monospace font
...
// Parse "elunium:" URI into recipient object, return true on successful parsing
