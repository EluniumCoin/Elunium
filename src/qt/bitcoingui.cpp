                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Elunium Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a ELUNIUM address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and elunium: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Elunium Core"), this);
    aboutAction->setStatusTip(tr("Show information about Elunium Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Elunium"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your ELUNIUM addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified ELUNIUM addresses"));
    ...
    openAction->setStatusTip(tr("Open a elunium: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Elunium Core help message to get a list with possible Elunium command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Elunium Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Elunium network", "", count));
}
...
{
    QString strTitle = tr("Elunium Core"); // default title
