...
In order to support loading of multiple wallets in elunium-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is elunium.cpp.
...
Changes to elunium.cpp
----------------------
elunium.cpp is the entry point into elunium-qt, and as such, will require some minor modifications to provide hooks for
