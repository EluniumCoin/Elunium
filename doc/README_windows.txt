...
Intro
-----
Elunium (ELUNIUM) is a sustainable cryptocurrency modeled after 
...
high-powered mining hardware. Elunium utilizes an energy efficient proof-of-stake algorithm, 
...
Setup
-----
Unpack the files into a directory and run elunium-qt.exe.

Elunium Core is the original Elunium client and it builds the backbone of the network.
However, it downloads and stores the entire history of Elunium transactions;
